...
CREATE TABLE `loan` (
  ...
  CONSTRAINT `loan_ibfk_2` FOREIGN KEY (`BorrowerID`) REFERENCES `borrower` (`BorrowerID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-07 15:02:03
-- MySQL dump 10.13  Distrib 8.0.44, for Win64 (x86_64)
--
...
CREATE TABLE `treatment` (
  ...
  CONSTRAINT `treatment_ibfk_1` FOREIGN KEY (`AppointmentID`) REFERENCES `appointment` (`AppointmentID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
